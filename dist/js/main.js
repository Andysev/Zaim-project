...
function offerTable() {
  $('.offers_table  .offer_tab-title').on('click', function(event) {
    var id = $(this).attr('data-id');
      $('.container').find('.slider').removeClass('tab-active').hide();
      $('.container').find('.slider2').removeClass('tab-active').hide();
      $('.container').find('.slider3').removeClass('tab-active').hide();
      $('.offers_table').find('.offer_tab-title').removeClass('table-active');
      $(this).addClass('table-active');
      $('#'+id).addClass('tab-active').fadeIn();
      return false;
    });
}
offerTable();
...
function slider6() {
  let slider = document.querySelector('.slider6'),
  sliderList = slider.querySelector('.slider-list'),
  sliderTrack = slider.querySelector('.slider-track'),
  slides = slider.querySelectorAll('.slide'),
  arrows = slider.querySelector('.slider-arrows'),
...
function otzivSlider() {
  let slider = document.querySelector('.otziv_slider'),
  sliderList = slider.querySelector('.slider-list'),
  sliderTrack = slider.querySelector('.slider-track'),
  slides = slider.querySelectorAll('.slide'),
  arrows = slider.querySelector('.slider-arrows'),
